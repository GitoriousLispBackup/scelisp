    ...
    (with-interface
      (with-objects ((scene scene)
        ...
        (with-mesh (mesh "/home/quentin/scelisp/examples/cube.obj")
          (let ((str (foreign-alloc :string :initial-contents (list "/home/quentin/scelisp/examples/lisp.png" (null-pointer)) :count 2)))
